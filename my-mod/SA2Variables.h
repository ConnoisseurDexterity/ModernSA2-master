...
DataArray(CharacterSoundBank, CharacterSoundBanks1P, 0x1739F58, 12);
DataArray(CharacterSoundBank, CharacterSoundBanks2P, 0x1739FB8, 8);
DataArray(CharacterVoiceBank, CharacterVoiceBanks1P, 0x173A018, 10);
DataArray(CharacterVoiceBank, CharacterVoiceBanks2P, 0x173A0B8, 7);
...
DataPointer(char, SoundsPaused, 0x174AFD9);
...
DataArray(EntityData2*, MainCharData2, 0x1DE95E0, 8);
DataArray(motionwk2*, playermwp, 0x1DE95E0, 8);
DataArray(CharObj2Base*, MainCharObj2, 0x1DE9600, 8);
DataArray(playerwk*, playerpwp, 0x1DE9600, 8);
DataArray(ModelIndex, CharacterModels, 0x1DE9620, 532);
DataArray(EntityData1*, MainCharObj1, 0x1DEA6C0, 8);
DataArray(taskwk*, playertwp, 0x1DEA6C0, 8);
DataArray(ObjectMaster*, MainCharacter, 0x1DEA6E0, 8);
DataArray(task*, playertp, 0x1DEA6E0, 8);
...
//MSA2 Lightfield Additions by Hoppy
DataArray(ObjectListEntry, MetalHarbour_ObjectArray, 0xAEC550, 0x5D); // cacl added (correct)
DataArray(ObjectListEntry, WhiteJungle_ObjectArray, 0xE995D0, 0x53); // cacl added (correct)
DataArray(ObjectListEntry, CrazyGadget_ObjectArray, 0x9BB0D0, 0x4F); // cacl added (correct)
DataArray(ObjectListEntry, WeaponsBed_ObjectArray, 0x9CC1F8, 0x56); // cacl added (correct)
//DataArray(ObjectListEntry, CityEscape_ObjectArray, 0x109E830, 0x66); // cacl added
//From Dash Adventure 2//
DataArray(ObjectListEntry, FinalChase_ObjectArray, 0x1536A98, 84); // cacl added (correct)
DataArray(ObjectListEntry, SkyRail_ObjectArray, 0x01178038, 0x55); // cacl added (correct)
DataArray(ObjectListEntry, GreenForest_ObjectArray, 0x1085C30, 0x59); // cacl added (correct)
DataArray(ObjectListEntry, PyramidCave_ObjectArray, 0xAB6080, 0x5F); // cacl added (correct)
DataArray(ObjectListEntry, PrisonLane_ObjectArray, 0x0104BDD8, 0X63); // cacl added
DataArray(ObjectListEntry, IronGate_ObjectArray, 0x00BED8F0, 0X5C); // cacl added
DataArray(ObjectListEntry, EternalEngine_ObjectArray, 0x00983EC0, 0X5D); // cacl added
DataArray(ObjectListEntry, MeteorHerd_ObjectArray, 0x01155B08, 0X5D); // cacl added
DataArray(ObjectListEntry, AquaticMine_ObjectArray, 0x01638760, 0X6F); // cacl added

DataArray(ObjectListEntry, GreenHill_ObjectArray, 0x010EDF28, 0X4C); // cacl added